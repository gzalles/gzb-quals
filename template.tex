...
\usepackage[colorinlistoftodos]{todonotes} %gzb
...
%hyperlinks package
\usepackage[colorlinks=true, pdfstartview=FitV, linkcolor=blue, citecolor=blue, urlcolor=blue, plainpages=false, pdfpagelabels]{hyperref}
...
\include{a1}%appendix for scores (figures) related to ch1
\include{a2}%appendix for math (equations) related to ch2
\include{a3}%appendix for cse (code) related to ch3

% \include{p1}%proposal TRE - NIME
% \include{p2}%proposal TRS - AES
% \include{p3}%proposal SDY - ICMC
