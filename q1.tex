...
\todo[inline]{Simon Emmerson, Trevor Wishart, Fred Lehrdahl, Dennis Smalley, see macedo-2015-snd-in-space.pdf} 

\todo[inline]{Memory Machine 2010 and Aeolian 2016 are the only 2 pieces by Emmerson that seem to deal with multichannel acoustics. Can't seem to find info on them though.}
...
\todo[inline]{these are all from a single anthology. I will find other sources as well.}
...
%noteworthy XR music experiences

\subsection{Film and Theatre}
